...
sed -i 's/config.apacheWebServerEnvArgs=/config.apacheWebServerEnvArgs=DT_CUSTOM_PROP=DEPLOYMENT_ID=123 DEPLOYMENT_GROUP_NAME=Production APPLICATION_NAME=easyTravel SERVICE_NAME=CustomerApacheFrontend APPLICATION_TIER=Apache_Frontend/' easyTravelConfig.properties
